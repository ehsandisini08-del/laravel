...
test('customer creation with invalid data returns validation errors', function () {
    ...
    $response->assertSessionHasErrors(['name', 'phone', 'nik', 'address', 'latitude', 'longitude', 'area_id', 'router_id', 'package_id', 'ppp_username', 'ppp_password', 'installation_date', 'due_day']);
});
