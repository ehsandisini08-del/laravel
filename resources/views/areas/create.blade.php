    ...
    <div class="max-w-2xl">
        ...
        <form method="POST" action="{{ route('areas.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required maxlength="100" placeholder="Jakarta" class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">Create Area</button>
            </div>
        </form>
    </div>
</x-admin-layout>
