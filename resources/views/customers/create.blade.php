            ...
            <x-card title="Identitas Pelanggan">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">Gunakan "Ambil Foto" untuk memotret langsung atau "Pilih File" dari galeri, lalu klik "Scan NIK". Pastikan foto jelas dan tidak buram.</p>
                    </div>
                </div>
            </x-card>
