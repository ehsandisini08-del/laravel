    ...
    <div class="max-w-2xl" x-data="templateForm()">
        ...
        <form method="POST" action="{{ route('whatsapp.templates.store') }}" class="space-y-6">
            ...
            <x-card title="Template Info">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" class="mt-1 block w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div>
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <button type="submit" class="app-btn-primary px-4 py-2.5 text-sm">Create Template</button>
            </div>
        </form>
    </div>
</x-admin-layout>
