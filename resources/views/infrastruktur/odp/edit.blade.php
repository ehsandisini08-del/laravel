<x-admin-layout>
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit ODP</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Perbarui data Optical Distribution Point</p>
            </div>
    ...
    <div class="max-w-3xl">
        ...
        <form method="POST" action="{{ route('odps.update', $odp) }}" class="space-y-6">
            @csrf
            @method('PUT')
