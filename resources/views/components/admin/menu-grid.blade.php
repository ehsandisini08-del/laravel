...
<div class="space-y-5 lg:hidden">
    ...
    <div class="app-card p-4 sm:p-5">
        ...
        <div class="grid grid-cols-4 gap-2.5 sm:gap-3">
            ...
            <x-admin.menu-tile
                label="Cetak Invoice"
                href="{{ route('billing.cetak-invoice') }}"
    ...
    <div class="app-card p-4 sm:p-5">
        ...
        <div class="grid grid-cols-4 gap-2.5 sm:gap-3">
            ...
            <x-admin.menu-tile
                label="Buat Tugas"
                href="{{ route('teknisi.buat-tugas') }}"
                icon="M12 4.5v15m7.5-7.5h-15"
                color="bg-blue-600"
                :active="request()->routeIs('teknisi.buat-tugas')"
            />
            @endif
            <x-admin.menu-tile
                label="Tugas Perbaikan"
                href="{{ route('teknisi.tugas-perbaikan') }}"
                icon="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 11-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.017l4.085 1.203a1.5 1.5 0 011.026 1.838l-.66 2.246a1.5 1.5 0 01-1.838 1.026l-4.085-1.203a3.57 3.57 0 01-1.378-.855"
                color="bg-amber-600"
            ...
            <x-admin.menu-tile
                ...
                color="bg-indigo-600"
                :active="request()->routeIs('teknisi.laporan-harian')"
            />
            <x-admin.menu-tile
                label="Laporan Pemasangan"
                href="{{ route('teknisi.laporan-pemasangan') }}"
                icon="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
                color="bg-emerald-600"
                :active="request()->routeIs('teknisi.laporan-pemasangan')"
            />
            <x-admin.menu-tile
                label="Pekerjaan"
                href="{{ route('teknisi.pekerjaan') }}"
                icon="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 00.75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 00-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0112 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 01-.673-.38m0 0A2.18 2.18 0 013 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 013.413-.387m7.5 0V5.25A2.25 2.25 0 0013.5 3h-3a2.25 2.25 0 00-2.25 2.25v.894m7.5 0a48.667 48.667 0 00-7.5 0M12 12.75h.008v.008H12v-.008z"
                color="bg-cyan-600"
                :active="request()->routeIs('teknisi.pekerjaan')"
            />
        </div>
    </div>
    @endif
    ...
    <div class="app-card p-4 sm:p-5">
        ...
        <div class="grid grid-cols-4 gap-2.5 sm:gap-3">
            ...
            <x-admin.menu-tile
                label="Barang"
                href="{{ route('gudang.barang.index') }}"
                icon="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"
                color="bg-blue-600"
                :active="request()->routeIs('gudang.barang.*')"
            />
            <x-admin.menu-tile
                label="Kategori"
                href="{{ route('gudang.kategori.index') }}"
                icon="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"
                color="bg-purple-600"
                :active="request()->routeIs('gudang.kategori.*')"
            />
            <x-admin.menu-tile
                label="Barang Masuk"
            ...
            <x-admin.menu-tile
                label="Stok Opname"
                href="{{ route('gudang.opname.index') }}"
                icon="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"
                color="bg-amber-500"
                :active="request()->routeIs('gudang.opname.*')"
            />
            <x-admin.menu-tile
                label="Riwayat Stok"
                href="{{ route('gudang.riwayat') }}"
                icon="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"
                color="bg-cyan-600"
                :active="request()->routeIs('gudang.riwayat')"
            />
        </div>
    </div>
    @endif
