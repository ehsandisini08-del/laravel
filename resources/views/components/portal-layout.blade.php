    ...
    <nav class="fixed inset-x-0 bottom-0 z-50 mx-auto max-w-md">
        <div class="border-t border-slate-100 bg-white/95 px-2 pb-[env(safe-area-inset-bottom)] backdrop-blur-lg">
            <div class="grid grid-cols-4 gap-1 py-2">
                ...
                <a href="{{ route('portal.wifi') }}" class="{{ request()->routeIs('portal.wifi*') ? 'text-[#2563eb]' : 'text-slate-400' }} flex flex-col items-center gap-1 py-1.5 transition-colors">
                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="{{ request()->routeIs('portal.wifi*') ? '2.2' : '1.7' }}">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.288 15.038a5.25 5.25 0 017.424 0M5.106 11.856c3.807-3.808 9.98-3.808 13.788 0M1.924 8.674c5.565-5.565 14.587-5.565 20.152 0M12.53 18.22l-.53.53-.53-.53a.75.75 0 011.06 0z" />
                    </svg>
                    <span class="text-[11px] font-medium">WiFi</span>
                </a>
