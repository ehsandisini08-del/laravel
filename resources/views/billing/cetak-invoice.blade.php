<x-admin-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Cetak invoice pelanggan</p>
        </div>
    </x-slot>
    ...
    <x-card>
        <div class="text-center py-16">
            ...
            <h3 class="mt-4 text-lg font-semibold text-gray-900 dark:text-white">Cetak Invoice</h3>
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 max-w-md mx-auto">Modul Cetak Invoice akan tersedia di sini.</p>
            <div class="mt-4">
